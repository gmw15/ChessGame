/**
 * In this class we are representing the board and marking out the rows and columns.
 * Even do we have the board in an image that is jus for design purposes. This is where I am
 * painting and drawing the pieces to.
 * So basically it represents the state of the game and the rules.
 */
